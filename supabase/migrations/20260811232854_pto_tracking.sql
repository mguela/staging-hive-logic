-- Canonical capture of sql/069_pto_tracking.sql into supabase/migrations.
-- Objects were already applied directly to production (2026-08-11), including
-- the RLS enable; this file records them in the migration ledger so a fresh
-- install reproduces them. Idempotent -- safe if it ever re-runs.
--
