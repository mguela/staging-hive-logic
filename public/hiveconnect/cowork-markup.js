...
(function () {
  ...
  function injectStyles() {
    ...
    css.textContent = [
      '.cwm-root{position:fixed;inset:0;z-index:2147483000;pointer-events:none;font-family:"Inter",system-ui,sans-serif}',
      ...
      '.cwm-cur{position:absolute;transition:left .06s,top .06s}.cwm-cur span{position:absolute;left:15px;top:11px;font:600 11px "Inter",sans-serif;color:#fff;padding:1px 7px;border-radius:6px;white-space:nowrap;box-shadow:0 2px 6px rgba(0,0,0,.3)}',
      '.cwm-ping{position:absolute;transform:translate(-50%,-50%)}.cwm-ping i{position:absolute;left:-16px;top:-16px;width:32px;height:32px;border-radius:50%;border:2px solid currentColor;animation:cwmp 2s cubic-bezier(.15,.6,.3,1) infinite}.cwm-ping b{position:absolute;left:-7px;top:-7px;width:14px;height:14px;border-radius:50%;background:currentColor;box-shadow:0 0 0 3px rgba(255,255,255,.85)}.cwm-ping span{position:absolute;left:15px;top:-9px;color:#fff;font:600 11px "Inter",sans-serif;padding:2px 8px;border-radius:6px}',
      ...
      '.cwm-panel{position:fixed;z-index:2147483600;display:flex;flex-direction:column;background:linear-gradient(180deg,#181f2c,#131923);border:1px solid #283245;border-radius:16px;pointer-events:auto;box-shadow:0 1px 0 rgba(255,255,255,.06) inset,0 24px 64px -14px rgba(0,0,0,.65);overflow:hidden;min-width:240px;max-height:88vh;font-family:"Inter",system-ui,sans-serif}',
      ...
      '.cwm-title{font:700 13px "Inter",sans-serif;letter-spacing:-.01em;color:#eef4f8}.cwm-driver{display:inline-flex;align-items:center;gap:6px;padding:3px 9px;border-radius:99px;background:rgba(95,131,166,.16);border:1px solid rgba(95,131,166,.42);color:#b7c9dc;font:600 10px "Inter",sans-serif}.cwm-driver:empty{display:none}',
      '.cwm-head .cwm-mini{margin-left:auto}.cwm-head .cwm-mini+.cwm-mini{margin-left:0}',
      '.cwm-tabs{display:flex;gap:2px;padding:8px 10px 0}.cwm-tabs button{flex:1;border:0;background:rgba(255,255,255,.04);color:#9aa6b8;font:600 11.5px "Inter",sans-serif;padding:8px;border-radius:9px 9px 0 0;cursor:pointer}.cwm-tabs button.on{background:rgba(95,131,166,.24);color:#eaf1f7}',
      ...
      '.cwm-funrow{display:grid;grid-template-columns:repeat(2,1fr);gap:6px}.cwm-fbtn{border:1px solid transparent;background:rgba(255,255,255,.04);color:#eef4f8;border-radius:10px;padding:10px;font:600 12px "Inter",sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px;transition:all .14s}.cwm-fbtn:hover{background:rgba(255,255,255,.09)}.cwm-fbtn.on{background:#5f83a6}.cwm-fbtn svg{width:15px;height:15px;fill:none;stroke:currentColor;stroke-width:2}',
      '.cwm-file{padding:6px 0;border-bottom:1px solid rgba(255,255,255,.06)}.cwm-file b{color:#eef4f8;font:600 12px "Inter",sans-serif}.cwm-file small{display:block;color:#8b94a3;font-size:10.5px}.cwm-dim{color:#6f7c90;font-size:11px}',
      ...
      '.cwm-toast{position:fixed;left:50%;top:20px;transform:translateX(-50%);z-index:2147483600;background:linear-gradient(180deg,#181f2c,#131923);border:1px solid #283245;color:#eef4f8;font:600 12.5px "Inter",sans-serif;padding:11px 16px;border-radius:12px;box-shadow:0 16px 40px -8px rgba(0,0,0,.6);display:flex;gap:11px;align-items:center;pointer-events:auto}.cwm-toast button{border:0;background:#5f83a6;color:#fff;border-radius:8px;padding:6px 12px;font:600 12px "Inter",sans-serif;cursor:pointer}',
